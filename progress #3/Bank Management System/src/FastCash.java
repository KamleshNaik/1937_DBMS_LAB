...
public class FastCash extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
            ...
            if(ae.getSource()==b1){
                    ...
                    ResultSet rs = c1.s.executeQuery(" select * from bank where pin = '"+a+"' order by sno desc limit 1");
                    ...
                    if(rs.next()){
                        ...
                        balance-=100;
                        String q1= "insert into bank values('"+pin+"',null,100,'"+balance+"','"+accno+"','"+sno+"')";
                    ...
                    ResultSet rs = c1.s.executeQuery(" select * from bank where pin = '"+a+"' order by sno desc limit 1 order by sno desc limit 1 ");
                    ...
                    if(rs.next()){
                        ...
                        sno++;
                        balance-=500;
                        String q1= "insert into bank values('"+pin+"',null,500,'"+balance+"','"+accno+"','"+sno+"')";
                    ...
                    if(rs.next()){
                        ...
                        sno++;
                        balance-=1000;
                        String q1= "insert into bank values('"+pin+"',null,1000,'"+balance+"','"+accno+"','"+sno+"')";
                    ...
                    if(rs.next()){
                        ...
                        sno++;
                        balance-=2000;
                        String q1= "insert into bank values('"+pin+"',null,2000,'"+balance+"','"+accno+"','"+sno+"')";
                    ...
                    if(rs.next()){
                        ...
                        sno++;
                        balance-=5000;
                        String q1= "insert into bank values('"+pin+"',null,5000,'"+balance+"','"+accno+"','"+sno+"')";
                    ...
                    if(rs.next()){
                        ...
                        sno++;
                        balance-=10000;
                        String q1= "insert into bank values('"+pin+"',null,10000,'"+balance+"','"+accno+"','"+sno+"')";
